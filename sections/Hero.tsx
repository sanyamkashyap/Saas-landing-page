      ...
      <div className="container">
        <div className="md:flex items-center">
          <div className="md:w-[478px]">
            ...
            <p className="text-xl text-[#010D3E] tracking-tight mt-6 ">Celebrate the joy of accomplishment with app designed to track your progress, motivate your efforts, and celebrate your successes</p>
